...
function HeroSection() {
    const slides = [
        {
            id:1,
            icon:<Leaf className='w-20 h-20 sm:w-20 sm:h-20 text-green-400 drop-shadow-lg'/>,
        ...
        {
            id:2,
            icon:<Truck className='w-20 h-20 sm:w-20 sm:h-20 text-yellow-400 drop-shadow-lg'/>,
            title:"Fast and Reliable Delivery 🚚",
            Subtitle :"We ensure your groceries reach your doorstep in no time.",
            btnText :"Order Now",
            bg:"https://images.unsplash.com/photo-1607273685680-6bd976c5a5ce?q=80&w=1740&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
            
        },
        {
            id:3,
            icon:<Smartphone className='w-20 h-20 sm:w-20 sm:h-20 text-blue-400 drop-shadow-lg'/>,
            title:"Shop Anytime, Anywhere 📱",
            Subtitle :"Easy and seamless online grocery shopping experience.",
            btnText :"Get Started",
            bg:"https://images.unsplash.com/photo-1605447813584-26aeb3f8e6ae?q=80&w=2940&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
        },
    ...
    return (
        <div className='relative w-[98%] mx-auto mt-32 h-[80vh] rounded-3xl overflow-hidden shadow-2xl '>
            ...
            {slides.map((_,index)=>(
                <button 
                key={index}
                className={`w-3 h-3 rounded-full transition-all ${index===current ? "bg-white w-6" :"bg-gray-50"}`}>
                </button>
            ))}
            </div>
        </div>
