...
function AdminOrderCard({ order }: { order: IOrder }) {
    ...
    const assignedBoy = order.assignedDeliveryBoy && typeof order.assignedDeliveryBoy === 'object'
                        ...
                        <div className="mt-4 bg-blue-50 border border-blue-200 rounded-xl p-4 flex items-center justify-between mb-4">
                            <div className="flex items-center gap-3 text-sm text-gray-700">
                                ...
                                <div className="font-semibold text-gray-800">
                                    <p>Assigned To: <span>{assignedBoy.name}</span></p>
                                    <p className="text-xs text-gray-600">📞 +91 {assignedBoy.mobile}</p>
                                </div>
                            </div>
                            <a href={`tel:${assignedBoy.mobile}`} className="bg-blue-600 text-white text-xs px-3 py-1.5 rounded-lg hover:bg-blue-700 transition ml-2">Call</a>
                        </div>
                    )}
                </div>
