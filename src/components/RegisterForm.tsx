...
<div className='w-full flex items-center justify-center gap-3 border border-gray-300 hover:border-gray-50 py-3 rounded-3xl text-gray-400 font-medium transition-all duration-200 cursor-pointer' onClick={()=>signIn("google")}>
