  ...
  return (
    <div className='flex flex-col items-center justify-center min-h-[80vh] px-6 text-center bg-linear-to-b from-green-50 to-white'>
        ...
        >
            ...
            <div className="absolute top-49 left-[70%] w-2 h-2 bg-green-400 rounded-full animate-pulse"/>
            <div className="absolute top-32 left-[90%] w-2 h-2 bg-green-400 rounded-full animate-bounce"/>
        </motion.div>
    </div>
  )
}
